...
Unificated_Game is a real-time strategy (RTS) simulator designed as a comprehensive integration platform for five core Computer Science disciplines. Developed over a 12-week timeframe by a two-person team, the project simulates a networked environment where "data packets" compete for resources within a distributed, highly optimized, and containerized ecosystem.
...
git clone https://github.com/your-repo/Unificated_Game.git
...
S1-S2: Infrastructure. Initial Handshake and Dockerization setup.

S3-S4: World & Movement. Shared grid implementation and network synchronization.

S5-S6: Game Logic. Resource systems, combat mechanics, and health management.

S7-S8: Tactical AI. Implementation of intelligent navigation (A*).

S9-S10: Strategic Optimization. Integration of the Simplex model for bot decision-making.

S11-S12: QA & Polish. Load testing, bug fixing, and final documentation.
